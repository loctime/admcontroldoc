...
export default function Features() {
  ...
  return (
    <section className="py-8 w-full max-w-full mx-auto" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-center mb-8">Sistema de gestión automática de documentos empresariales</h2>
        ...
        <p className="text-center text-muted-foreground mb-8 text-2xl">
