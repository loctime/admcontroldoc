    ...
    <div className="min-h-screen pt-20 px-4 text-foreground">
      <div className="max-w-5xl mx-auto mb-1 text-center">
        ...
        <p className="text-muted-foreground text-lg">
          Elige el plan que mejor se adapta a las necesidades de tu empresa. Todos nuestros planes incluyen soporte,
          actualizaciones y acceso a las funcionalidades clave de ControlDoc.
        </p>
      </div>
      <Pricing />
    </div>
